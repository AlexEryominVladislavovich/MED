...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='profile',
            name='is_guest',
            field=models.BooleanField(default=False, verbose_name='Гостевой пользователь'),
        ),
        migrations.AddField(
            model_name='profile',
            name='username',
            field=models.CharField(default='user', max_length=50, unique=True, verbose_name='Имя пользователя'),
        ),
